...
const Navbar = ({ children }) => {
    ...
    const dashLine1 = useRef(null)
    const dashLine2 = useRef(null)
    ...
    return (
        <div>
            ...
            <div onClick={()=> {
                ...
                dashLine1.current.style.backgroundColor = 'black';
                dashLine2.current.style.backgroundColor = 'black';

            }}
            onMouseLeave={() =>{
                navGreenRef.current.style.height = '0%'
                dashLine1.current.style.backgroundColor = 'white'
                dashLine2.current.style.backgroundColor = 'white'
            }}
            className=' h-12 relative bg-black mr-0 sm:w-[15vw] cursor-pointer'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full cursor-pointer'></div>
                <div className='relative h-full px-12 flex flex-col justify-center items-end gap-1.5 '>
                    <div ref={dashLine1} className='w-20 h-0.5 bg-white '></div>
                    <div ref={dashLine2} className='w-12 h-0.5 bg-white '></div>
                </div>
            </div>
        </div>
        <div>
